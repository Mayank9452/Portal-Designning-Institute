...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($numrows>0){
        ...
        if($result){
            $showalert=true;
            header("Location: /Portal-Designning-Institute/college_medical/college.php?signupsuccess=true");
            exit();
        }
    }
    else{
 ...
 header("Location: /Portal-Designning-Institute/college_medical/college.php?signupsuccess=false & error=$showerror");
